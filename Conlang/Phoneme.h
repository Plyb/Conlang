...
enum PhonemeTypes { CONSONANT, PULMONIC, VOICED, UNVOICED, 
	...
	PLOSIVE, SIBILANT, NONSIBILANT, FRICATIVE, NASAL, APPROXIMANT, TAP, TRILL, LATERAL_FRICATIVE, LATERAL_APPROXIMANT, LATERAL_TAP, 
	AFFRICATE, COARTICULATED,
	NONPULMONIC, CLICK, IMPLOSIVE, EJECTIVE, //For economy, clicks should be encoded as Bilabial, Dental, alveolar, or palatal with unvoiced, voiced, nasal "Lateral Frivative"
